...
export const ListInvertersResponseItem = zod.object({
  ...
  tipoRede: zod.enum(["monofasico", "trifasico", "desconhecido"]).optional(),
  tensaoAcNominal: zod.string().optional(),
  ligacaoRede: zod.string().optional(),
  faixaTensaoAc: zod.string().optional(),
  frequenciaAc: zod.string().optional(),
  potenciaAparenteAc: zod.number().nullish(),
  correnteNominalAc: zod.number().nullish(),
  correnteMaxAc: zod.number().nullish(),
  fatorPotencia: zod.string().optional(),
  thdi: zod.string().optional(),
  correnteInjecaoDc: zod.string().optional(),
  potenciaPvMax: zod.number().nullish(),
  potenciaDcNominal: zod.number().nullish(),
  tensaoArranque: zod.number().nullish(),
  tensaoNominalDc: zod.string().optional(),
  correnteCurtoCircuitoMppt: zod.number().nullish(),
  bateriaTensaoRange: zod.string().optional(),
  bateriaCorrenteCargaMax: zod.number().nullish(),
  bateriaCorrenteDescargaMax: zod.number().nullish(),
  bateriaPotenciaCargaMax: zod.number().nullish(),
  bateriaPotenciaDescargaMax: zod.number().nullish(),
  grauProtecao: zod.string().optional(),
  comunicacao: zod.string().optional(),
  observacoesTecnicas: zod.string().optional(),
  createdAt: zod.coerce.date(),
});
